...
function pieDimLoad(parent) {
  return () => {
    return dimPie(parent);
  }
}


let setPieOpacity = setOpacity(svg, '.pie');

function pieGraph(data, colorDomain) {
  return prePie(svg, data, {color, arc, pie:calculatPie, colorDomain});
}

export {pieGraph, setPieOpacity};
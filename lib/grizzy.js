...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scheduler_globals = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.queueSubject = undefined;
	...
	var _sharedResource = __webpack_require__(9);

	var _intent = __webpack_require__(10);
	...
	var queueStream = _intent.queueSubject.startWith(stagedState).scan(queueModel).skip(1).filter(function (obj) {
	...
	var mergeSubject = _rx2.default.Observable.merge(singleStream, backFromRenderStream);
	...
	.filter(function (state) {
	  ...
	  (0, _view.views)(transitionStage);
	});

	exports.queueSubject = _intent.queueSubject;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.pick = exports.target = exports.source = exports.Queue = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.scheduleSubject = exports.queueSubject = undefined;
	...
	var queueSubject = exports.queueSubject = new _rx2.default.ReplaySubject(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function dataModel(state, update) {
	  ...
	  switch (type) {
	    case _scheduler_globals.PRE_BIND:
	      return packDataBind(state, update);
	      break;

	    case _scheduler_globals.RENDER:
...
/***/ function(module, exports) {
	...
	var PRE_BIND = exports.PRE_BIND = 'pre-bind';
	var BIND = exports.BIND = 'bind';

	var PRE_RENDER = exports.PRE_RENDER = 'pre-render';
	var RENDER = exports.RENDER = 'render';

	var FINISH = exports.FINISH = 'finish';

	var CALL_NEXT = exports.CALL_NEXT = 'call-next';
	...
	*/
	...
	function renderView(state) {
	  if (state.callIndex < state.len && state.parent !== undefined) {
	    ...
	    _intent.queueSubject.onNext({ type: _scheduler_globals.FINISH, time: state.time });
	  }
	}

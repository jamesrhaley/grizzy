...
// example file to build a canvas method that follows the others
...
function delayedChange(data, delay) {
  var timeoutID = window.setTimeout(function () {
  	drawCustom(data);
  }, delay);
}
delayedChange([6,2,13,2,23], 2000);

delayedChange([9,1,120,16,20], 5000);